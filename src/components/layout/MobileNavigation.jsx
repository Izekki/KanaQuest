      ...
      <div className="mx-auto w-full max-w-md px-2 py-1">
        <div className="grid grid-cols-3 items-center text-xs font-semibold">
          <Link
            to="/game"
            className={[
              'flex flex-col items-center justify-center gap-1 py-2 min-h-[48px] rounded-xl transition-colors active:scale-95',
          ...
          >
            ...
            />
            <span className="text-[11px] leading-tight">Aprender</span>
          </Link>
          ...
          <Link
            ...
            className={[
              'flex flex-col items-center justify-center gap-1 py-2 min-h-[48px] rounded-xl transition-colors active:scale-95',
              pathname === '/sentence-builder' || pathname.startsWith('/sentence-builder') ? 'text-[rgb(var(--color-accent))] font-bold' : 'text-neutral/60 hover:text-neutral',
            ].join(' ')}
          >
            <span className="text-xl leading-none">✍️</span>
            <span className="text-[11px] leading-tight">Constructor</span>
          </Link>
          ...
          >
            ...
            />
            <span className="text-[11px] leading-tight">Historial</span>
          </Link>
        </div>
      </div>
    </nav>
